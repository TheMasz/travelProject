        ...
        <div class="plans-wrap">
                ...
                @foreach ($myplans as $plan)
                    ...
                    <div class="plan">
                        ...
                        <div class="details">
                            ...
                            <div class='btns row'>
                                <button
                                    onClick='usePlan("{{ str_replace(' ', '', $locationIdsString) }}", ".plans-wrap h3")'
                                    class="btn-primary">
                                    ใช้แผนท่องเที่ยวนี้
                                </button>
            ...
            @else
                <div class='back-home'>
                    ...
                    <p class='mb-2' style='color:lightgray; text-align:center; width:75%'>
                        ยังไม่มีสถานที่ท่องเที่ยวในการเดินของคุณ
                        กรุณาเริ่มด้วยการเลือกสถานที่ที่คุณต้องการเพิ่มเข้าในแผนการท่องเที่ยวของคุณ
                        คุณสามารถเริ่มการค้นหาและเพิ่มสถานที่ท่องเที่ยวได้ที่หน้าหลักของเรา</p>
