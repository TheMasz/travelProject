                    ...
                    <div class="col-sm-4">
                        <form action="{{ route('search.pre') }}" method="GET">
                            <div class="input-group" style="text-align: right">
                                <input type="text" placeholder="ค้นหาประเภทความชอบ" name="search" id="search"
                                    class="form-control" style="width: 220px;" />
                                <button class="btn btn-danger" title="ค้นหา" type="submit"><span><i
                            ...
                            <div class="col-md-3" style="margin-top: 10px;">
                                <div class="card" style="box-shadow: 0 0 20px rgba(255, 0, 0 ,0.20);">
                                    ...
                                    <div class="card-footer" style="text-align: right;">
                                        <a href='#edit{{ $item->preference_id }}' data-toggle='modal'><button
                                                style="margin-right: 5px;" class="btn btn-warning btn-sm"
                                                title="แก้ไขข้อมูลความชอบ" type="submit"><span><i
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('insertpreference') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
            ...
            <div class="modal fade" id="edit{{ $item->preference_id }}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('update-preference', $item->preference_id) }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-12" style="margin-top: 20px;">
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" class="form-control" name="preference_name"
                                                value="{{ $item->preference_name }}" required>
                                        </div>
                                    </div>
                                </div>
