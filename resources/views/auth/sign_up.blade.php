            ...
            <div class="cont-rt w-50 px-5">
                ...
                <form action="register" method="post">
                    ...
                    <div class="input-wrap row mb-4">
                        ...
                        <input type="password" placeholder="รหัสผ่านของคุณ" name="password" required minlength="8"
                            maxlength="16" />
                    </div>
                    <div class="input-wrap row mb-4">
                        <span class="material-icons">password</span>
                        <input type="password" placeholder="ยืนยันรหัสผ่านของคุณ" name="cf_password" required
